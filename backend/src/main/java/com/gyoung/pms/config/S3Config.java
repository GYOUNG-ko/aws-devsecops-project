...
@Configuration
@EnableConfigurationProperties({PmsS3Properties.class, PmsAwsProperties.class})
public class S3Config {

    @Bean
    S3Client s3Client(PmsAwsProperties properties) {
    ...
    @Bean
    S3Presigner s3Presigner(PmsAwsProperties properties) {
