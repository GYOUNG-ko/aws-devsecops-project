mock_provider "aws" {
  mock_resource "aws_iam_policy" {
    defaults = {
      arn = "arn:aws:iam::<AWS_ACCOUNT_ID>:policy/test-policy"
    }
  }
}
variables {
  oidc_provider_arn        = "arn:aws:iam::<AWS_ACCOUNT_ID>:oidc-provider/oidc.eks.ap-northeast-2.amazonaws.com/id/TEST"
